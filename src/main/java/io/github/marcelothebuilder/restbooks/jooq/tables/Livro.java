...
public class Livro extends TableImpl<LivroRecord> {
	...
	private static final long serialVersionUID = 848050449;
	 ...
	 */
	public final TableField<LivroRecord, Date> PUBLICACAO = createField("PUBLICACAO", org.jooq.impl.SQLDataType.DATE.nullable(false), this, "");
	...
	/**
	 * The column <code>PUBLIC.LIVRO.CODIGO_AUTOR</code>.
	 */
	public final TableField<LivroRecord, Long> CODIGO_AUTOR = createField("CODIGO_AUTOR", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
	 ...
	 */
	@Override
	public List<ForeignKey<LivroRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<LivroRecord, ?>>asList(Keys.FK_LIVRO_AUTOR);
	}
